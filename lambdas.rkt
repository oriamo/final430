...
(define (lambdas-e e)
  (match e
    ...
    [(Apply e1 e2 e3)       (append (lambdas-e e1) (lambdas-e e2) (lambdas-e e3))]
    [(LamPlain f xs e1)     (cons e (lambdas-e e1))]
    [(LamRest f xs x e1)    (cons e (lambdas-e e1))]
    [(Match e ps es)        (append (lambdas-e e) (append-map lambdas-e es))]
    [(Raise e)              (lambdas-e e)]
    [(WithHandlers ps hs e) (append (append-map lambdas-e ps) (append-map lambdas-e hs) (lambdas-e e))]
    [_                      '()]))
